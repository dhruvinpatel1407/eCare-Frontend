  ...
  return (
    <nav className="fixed w-full bg-white dark:bg-gray-800 shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <button className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
              <FiSettings className="text-gray-600 dark:text-gray-300" size={20} />
            </button>
            <button
            ...
            >
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 top-14 bg-white dark:bg-gray-800 shadow-lg rounded-md py-2 px-4 w-48 z-50">
                  <div className="flex flex-col space-y-2">
                    <Link to="/demographics" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                      My Profile
                    </Link>
                    <Link to="/report" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                      Medicle Reports
                    </Link>
                    <button className="text-red-600 dark:text-red-500 hover:text-red-700 dark:hover:text-red-600">
                      Logout
                    </button>
                  </div>
                </div>
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-16 right-0 w-full bg-white dark:bg-gray-800 shadow-lg">
