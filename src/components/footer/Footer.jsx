    ...
    <footer className="w-full bg-gray-800 text-gray-300 py-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="mb-4">
            <h3 className="text-xl font-bold text-blue-600 mb-2">eCare</h3>
            <p className="text-sm">
              Your trusted partner in healthcare services and appointment management.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/appointments" className="hover:text-blue-600 transition-colors duration-200">
                  Appointments
                </Link>
              </li>
            </ul>
